...
#
# Generated by export_simulation on Wed Nov 09 14:44:14 -0500 2016
#
################################################################################
...
switch to the './RAM1MIN.sh' script.

./RAM1MIN.sh -reset_run
...
./RAM1MIN.sh -noclean_files

For more information on the script, please type './RAM1MIN.sh -help'.
