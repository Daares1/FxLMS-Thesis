...
#
# Generated by export_simulation on Sat Nov 05 18:00:00 -0500 2016
#
################################################################################
...
switch to the './MACC_FILTER.sh' script.

./MACC_FILTER.sh -reset_run
...
./MACC_FILTER.sh -noclean_files

For more information on the script, please type './MACC_FILTER.sh -help'.
