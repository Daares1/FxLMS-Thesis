...
#
# Generated by export_simulation on Thu Nov 10 23:58:01 -0500 2016
#
################################################################################
...
switch to the './ROM_ERROR2.sh' script.

./ROM_ERROR2.sh -reset_run
...
./ROM_ERROR2.sh -noclean_files

For more information on the script, please type './ROM_ERROR2.sh -help'.
