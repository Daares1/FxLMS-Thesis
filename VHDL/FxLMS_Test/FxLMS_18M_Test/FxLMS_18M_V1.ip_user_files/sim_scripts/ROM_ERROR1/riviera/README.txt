...
#
# Generated by export_simulation on Thu Nov 10 23:55:49 -0500 2016
#
################################################################################
...
switch to the './ROM_ERROR1.sh' script.

./ROM_ERROR1.sh -reset_run
...
./ROM_ERROR1.sh -noclean_files

For more information on the script, please type './ROM_ERROR1.sh -help'.
